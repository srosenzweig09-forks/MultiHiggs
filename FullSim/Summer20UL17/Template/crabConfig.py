...
config.JobType.inputFiles  = ['scriptExe.sh', 'lheGen_step.py', 'sim_step.py','digiPremix_step.py','hlt_step.py','recoAOD_step.py','miniAOD_step.py','nanoAOD_step.py','NMSSM_XYH_YToHH_6b_MX_700_MY_400_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz']
...
config.Data.outputDatasetTag     = 'srosenzw_NMSSM_XYH_YToHH_6b_MX_700_MY_400_sl7_nano_100k'
