...
# with command line options: --python_filename HIG-RunIISummer20UL17MiniAODv2-00063_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:HIG-RunIISummer20UL17MiniAODv2-00063.root --conditions 106X_mc2017_realistic_v9 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein dbs:/QCD_HT1000to1500_BGenFilter_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL17RECO-106X_mc2017_realistic_v6-v1/AODSIM --era Run2_2017 --runUnscheduled --no_exec --mc -n 10000

import os
expected_cmssw = 'CMSSW_10_6_20'
...
#     fileNames = cms.untracked.vstring('file:recoAOD_step.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('miniAOD_step.py nevts:'+str(options.nEvents)),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:miniAOD_step.root'),
