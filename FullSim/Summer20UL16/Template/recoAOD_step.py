...
# with command line options: --python_filename HIG-RunIISummer20UL16RECO-00175_1_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:HIG-RunIISummer20UL16RECO-00175.root --conditions 106X_mcRun2_asymptotic_v13 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:HIG-RunIISummer20UL16HLT-00175.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 905
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:hlt_step.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('recoAOD_step.py nevts:'+str(options.nEvents)),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:recoAOD_step.root'),
