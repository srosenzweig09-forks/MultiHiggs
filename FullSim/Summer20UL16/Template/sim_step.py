...
# with command line options: --python_filename HIG-RunIISummer20UL16SIM-00175_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIG-RunIISummer20UL16SIM-00175.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --filein file:HIG-RunIISummer20UL16wmLHEGEN-00006.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 188

import os
expected_cmssw = 'CMSSW_10_6_17_patch1'
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:lheGen_step.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('sim_step.py nevts:'+str(options.nEvents)),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:sim_step.root'),
