...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL16wmLHEGEN-00006-fragment.py --python_filename HIG-RunIISummer20UL16wmLHEGEN-00006_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL16wmLHEGEN-00006.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 288

import os
expected_cmssw = 'CMSSW_10_6_18'
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('lheGen_step.py nevts:'+str(options.nEvents)),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('lheGen_step.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:lheGen_step_inLHE.root'),
...
process.LHEfilter = cms.EDFilter("LHEGenericFilter",
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring(os.environ['PWD']+"/NMSSM_XYH_YToHH_6b_MX_700_MY_400_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz"),
...
process.ProductionFilterSequence = cms.Sequence(process.LHEfilter+process.generator)
