...
# with command line options: --python_filename HIG-RunIISummer20UL16NanoAODv9-00090_1_cfg.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:HIG-RunIISummer20UL16NanoAODv9-00090.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein dbs:/QCD_HT1000to1500_BGenFilter_TuneCP5_13TeV-madgraph-pythia8/RunIISummer20UL16MiniAODv2-106X_mcRun2_asymptotic_v17-v1/MINIAODSIM --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n 10000

import os
expected_cmssw = 'CMSSW_10_6_26'
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('nanoAOD_step.py nevts:'+str(options.nEvents)),
